...
export const t = {
  // App / header
  appName: { zh: "FFmpeg 工作室 / FFmpeg Studio", en: "FFmpeg Studio" },
  theme: { zh: "切换主题 / Theme", en: "Theme" },
  settings: { zh: "设置 / Settings", en: "Settings" },
  help: { zh: "帮助 / Help", en: "Help" },
  // Sidebar sections
  secMedia: { zh: "媒体处理 / Media", en: "Media" },
  secAV: { zh: "音视频 / Audio & Video", en: "Audio & Video" },
  secAdv: { zh: "高级 / Advanced", en: "Advanced" },
  // Sidebar items
  navFormatConvert: { zh: "格式转换 / Format Convert", en: "Format Convert" },
  navCutTrim: { zh: "视频剪辑 / Cut & Trim", en: "Cut & Trim" },
  navMerge: { zh: "视频合并 / Merge", en: "Merge" },
  navFilters: { zh: "滤镜效果 / Filters", en: "Filters" },
  navAudio: { zh: "音频处理 / Audio", en: "Audio" },
  navSubtitles: { zh: "字幕处理 / Subtitles", en: "Subtitles" },
  navGif: { zh: "GIF 动图 / GIF", en: "GIF" },
  navRecord: { zh: "录屏录制 / Screen Record", en: "Screen Record" },
  navStream: { zh: "流媒体 / Streaming", en: "Streaming" },
  navInfo: { zh: "媒体信息 / Media Info", en: "Media Info" },
  // Engine status
  ...
  updateCurrentVersion: { zh: "当前版本 / Current version", en: "Current version" },
  updateChecking: {
    zh: "正在检查更新... / Checking for updates...",
    en: "Checking for updates...",
  },
  updateLatest: {
    zh: "已是最新版本 / You are on the latest version",
    en: "You are on the latest version",
  },
  updateNewVersion: { zh: "发现新版本 / New version available", en: "New version available" },
  updateDownload: { zh: "下载更新 / Download", en: "Download" },
  updateDownloading: { zh: "正在下载... / Downloading...", en: "Downloading..." },
  updateReady: {
    zh: "下载完成，点击安装并重启 / Download complete. Click to install and restart.",
  ...
  updateRestarting: { zh: "正在重启应用... / Restarting app...", en: "Restarting app..." },
  updateMajor: { zh: "大版本更新 / Major update", en: "Major update" },
  updateMajorHint: {
    zh: "这是大版本更新，请下载安装器并手动运行。安装后会刷新内置 FFmpeg。 / This is a major update. Download and run the installer manually; it refreshes the bundled FFmpeg.",
  ...
  updateCheckBtn: { zh: "检查更新 / Check Update", en: "Check Update" },
  // Settings dialog
  settingsProxy: { zh: "代理 / Proxy", en: "Proxy" },
  proxyEnabled: { zh: "启用代理 / Enable proxy", en: "Enable proxy" },
  proxySystem: { zh: "系统代理 / System proxy", en: "System proxy" },
  proxyCustom: { zh: "自定义 / Custom", en: "Custom" },
  proxyUrl: { zh: "代理地址 / Proxy address", en: "Proxy address" },
  proxyProtocol: { zh: "协议 / Protocol", en: "Protocol" },
  proxyCheckBaidu: { zh: "百度 / Baidu", en: "Baidu" },
  proxyCheckGoogle: { zh: "Google / Google", en: "Google" },
  proxyCheckSuccess: {
    zh: "{{target}} 连接成功 / {{target}} connection successful",
    en: "{{target}} connection successful",
  },
  proxyCheckFail: {
    zh: "{{target}} 连接失败: {{error}} / {{target}} connection failed: {{error}}",
    en: "{{target}} connection failed: {{error}}",
  },
  proxyUrlRequired: {
    zh: "请先填写代理地址，否则将直连目标 / Please enter a proxy address first, otherwise the target will be reached directly",
    en: "Please enter a proxy address first, otherwise the target will be reached directly",
  },
  githubMirror: { zh: "GitHub 镜像 / GitHub Mirror", en: "GitHub Mirror" },
  githubMirrorDesc: {
    zh: "下载 GitHub 资源时使用的镜像（留空则不替换） / Mirror used when downloading GitHub assets (empty = no replacement)",
    en: "Mirror used when downloading GitHub assets (empty = no replacement)",
  },
  settingsSaved: { zh: "设置已保存 / Settings saved", en: "Settings saved" },
  // Format convert
  ...
  noFileSelected: { zh: "未选择文件 / No file selected", en: "No file selected" },
  ...
  infoStreamN: { zh: "流 # / Stream #", en: "Stream #" },
  ...
  // Status bar
  estOut: { zh: "预计输出 / est. output", en: "est. output" },
  estTime: { zh: "用时 / est. time", en: "est. time" },
  // Toasts / dialogs
  ffmpegMissing: {
    zh: "未检测到 ffmpeg，无法执行。请安装 ffmpeg 后重试。 / ffmpeg not detected. Please install ffmpeg and retry.",
    en: "ffmpeg not detected. Please install ffmpeg and retry.",
  },
  failed: { zh: "转换失败 / Failed", en: "Failed" },
  runningMsg: { zh: "正在处理… / Processing…", en: "Processing…" },
  openFolder: { zh: "打开所在文件夹 / Open folder", en: "Open folder" },
  selectOutput: { zh: "选择输出位置 / Choose output location", en: "Choose output location" },
  // Coming soon
